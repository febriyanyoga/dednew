    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="card-title">Data Sub Organisasi untuk (Nama SKPA - Nama Organisasi)</h5>
                <br>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered display">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <a style="color: white;" class="btn btn-success" href="<?php echo base_url()?>masterdata/obyekdata"><i class="fa fa-edit"></i>Obyek Data</a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label for="recipient-name" class="control-label">Nama Suborganisasi :</label>
