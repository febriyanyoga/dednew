...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Data Organisasi untuk (Nama SKPA)</h5>
                <br>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered display">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                        <a class="btn btn-success" href="<?php echo base_url()?>masterdata/suborganisasi"><i class="fas fa-plus-circle"></i>  Sub Organisasi</a>
