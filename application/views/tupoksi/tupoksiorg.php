<div class="card-title">
    <h2 class="text-center"> Master Data Tupoksi Organisasi</h2>
</div><br>
<!-- File export -->
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Data Organisasi (Nama SKPA)</h4>
                <br>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered display">
                            <thead>
                                <tr>
                                    ...
                                    <th width="200px" class="text-center">Fungsi</th>
                                    <th width="200px" class="text-center">Tugas</th>
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                        <a class="btn btn-success" href="<?php echo base_url()?>tupoksi/suborganisasi"><i class="fas fa-plus-circle"></i>  Sub Organisasi</a>
                                            
                                            <a style="color: white;" class="btn btn-success" data-toggle="modal" data-target="#editskpa-<?php echo $d->id?>" title="edit"><i class="fa fa-edit"></i> Tupoksi</a>
