<div class="card-title">
    <h2 class="text-center"> Master Data Tupoksi Sub Organisasi</h2>
</div><br>
<!-- File export -->
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Data Sub Organisasi untuk (Nama SKPA - Nama Organisasi)</h4>
                <br>
                <p>
                    <?php
                        ...
                        <table id="zero_config" class="table table-striped table-bordered display">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <a style="color: white;" class="btn btn-success" href="<?php echo base_url()?>tupoksi/obyekdata"><i class="fa fa-edit"></i>Obyek Data</a>
