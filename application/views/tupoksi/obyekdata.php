<div class="card-title">
    <h2 class="text-center"> Master Data Obyek Data</h2>
</div><br>
<!-- File export -->
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Obyek Data untuk Tupoksi (Nama SKPA - Nama Organisasi - Nama Sub Organisasi)</h4>
                        ...
                        <table id="zero_config" class="table table-striped table-bordered display">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <a style="color: white;" class="btn btn-success" href="<?php echo base_url()?>tupoksi/tabeldata"><i class="fa fa-edit"></i>Tabel Data</a>
