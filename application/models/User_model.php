...
class User_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->add_column('action',anchor(site_url('user/update/$1'),'<i class="icon-pencil" aria-hidden="true"></i>', array('class' => 'btn-fab btn-fab-sm btn-primary r-5'))." 
                ".anchor(site_url('user/delete/$1'),'<i class="icon-trash-can " aria-hidden="true"></i>','class="btn-fab btn-fab-sm btn-danger r-5" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_users');
